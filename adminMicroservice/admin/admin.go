...
func CallUserMicroservice(w http.ResponseWriter, r *http.Request) {
	apiURL := "http://47.129.56.155:5100/api/v1/user/getAllUser"
...
func CallFESForUserResponse(w http.ResponseWriter, r *http.Request) {
	apiURL := "http://47.129.56.155:5300/api/v1/fes/getAllResponses"
...
func CallFESForUserResponseDetails(w http.ResponseWriter, r *http.Request) {
	apiURL := "http://47.129.56.155:5300/api/v1/fes/getAllIndividualRes" // URL to call `getAllFESIndividualRes` endpoint
...
func CallFAForAllUserTotalScore(w http.ResponseWriter, r *http.Request) {
	apiURL := "http://47.129.56.155:5250/api/v1/selfAssessment/getAllTotalScore"
...
func CallFAForAllUserTime(w http.ResponseWriter, r *http.Request) {
	apiURL := "http://47.129.56.155:5250/api/v1/selfAssessment/getAllAvgTime"
...
func CallFAForAllUserRisk(w http.ResponseWriter, r *http.Request) {
	apiURL := "http://47.129.56.155:5250/api/v1/selfAssessment/getAllUserRisk"
...
func CallFESLastResDayForAllUsers(w http.ResponseWriter, r *http.Request) {
	apiURL := "http://47.129.56.155:5300/api/v1/fes/getAllFESLastResDay"
...
func CallFALastResDayForAllUsers(w http.ResponseWriter, r *http.Request) {
	apiURL := "http://47.129.56.155:5250/api/v1/selfAssessment/getAllLastResDay"
...
func CallFESUserRiskLevel(w http.ResponseWriter, r *http.Request) {
	apiURL := "http://47.129.56.155:5300/api/v1/fes/getAllFESLatestRisk" // Replace with actual API URL
