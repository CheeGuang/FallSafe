...
func init() {
	...
	dbConnection := os.Getenv("ADMIN_DB_CONNECTION")
	if dbConnection == "" {
		log.Fatalf("ADMIN_DB_CONNECTION environment variable is not set")
	}
...
func CallUserMicroservice(w http.ResponseWriter, r *http.Request) {
	apiURL := "http://user-service.fallsafe-namespace.svc.cluster.local:5100/api/v1/user/getAllUser"
...
func CallFESForUserResponse(w http.ResponseWriter, r *http.Request) {
	apiURL := "http://fallsefficacy-service.fallsafe-namespace.svc.cluster.local:5300/api/v1/fes/getAllResponses"
...
func CallFESForUserResponseDetails(w http.ResponseWriter, r *http.Request) {
	apiURL := "http://fallsefficacy-service.fallsafe-namespace.svc.cluster.local:5300/api/v1/fes/getAllIndividualRes" // URL to call `getAllFESIndividualRes` endpoint
...
func CallFAForAllUserTotalScore(w http.ResponseWriter, r *http.Request) {
	apiURL := "http://selfassessment-service.fallsafe-namespace.svc.cluster.local:5250/api/v1/selfAssessment/getAllTotalScore"
...
func CallFAForAllUserTime(w http.ResponseWriter, r *http.Request) {
	apiURL := "http://selfassessment-service.fallsafe-namespace.svc.cluster.local:5250/api/v1/selfAssessment/getAllAvgTime"
...
func CallFAForAllUserRisk(w http.ResponseWriter, r *http.Request) {
	apiURL := "http://selfassessment-service.fallsafe-namespace.svc.cluster.local:5250/api/v1/selfAssessment/getAllUserRisk"
...
func CallFESLastResDayForAllUsers(w http.ResponseWriter, r *http.Request) {
	apiURL := "http://fallsefficacy-service.fallsafe-namespace.svc.cluster.local:5300/api/v1/fes/getAllFESLastResDay"
...
func CallFALastResDayForAllUsers(w http.ResponseWriter, r *http.Request) {
	apiURL := "http://selfassessment-service.fallsafe-namespace.svc.cluster.local:5250/api/v1/selfAssessment/getAllLastResDay"
...
func CallFESUserRiskLevel(w http.ResponseWriter, r *http.Request) {
	apiURL := "http://fallsefficacy-service.fallsafe-namespace.svc.cluster.local:5300/api/v1/fes/getAllFESLatestRisk" // Replace with actual API URL
