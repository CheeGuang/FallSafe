const API_FES_URL = `${window.location.protocol}//${window.location.hostname}:5300/api/v1`; // FES API URL
const API_OpenAI_URL = `${window.location.protocol}//${window.location.hostname}:5150/api/v1`; // openAI API URL
