...
async function fetchFATotalScoreFromAPI() {
  try {
    console.log(token);
    const response = await fetch(
      "http://47.129.56.155:5200/api/v1/admin/getAllFATotalScore",
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
async function fetchFAAvgTimeFromAPI() {
  try {
    const response = await fetch(
      "http://47.129.56.155:5200/api/v1/admin/getAllFATime",
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
async function fetchAllUserRiskFromAPI() {
  try {
    const response = await fetch(
      "http://47.129.56.155:5200//api/v1/admin/getAllFAUserRisk",
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
