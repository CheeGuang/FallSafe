...
async function fetchFESLastResponseDate() {
  try {
    ...
    const response = await fetch(
      "http://18.143.164.81:5200/api/v1/admin/getAllLastResFES",
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
async function fetchFallAssessmentLastResponseDate() {
  try {
    ...
    const response = await fetch(
      "http://18.143.164.81:5200/api/v1/admin/getAllLastResFA",
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
async function fetchLatestFAUserRiskFromAPI() {
  try {
    const response = await fetch(
      "http://18.143.164.81:5250/api/v1/selfAssessment/getAllUserRisk",
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
async function fetchLatestFESUserRiskFromAPI() {
  try {
    const response = await fetch(
      "http://18.143.164.81:5200/api/v1/admin/getAllFESUserRisk",
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
function confirmSendEmail(button) {
  ...
  fetch("http://18.143.164.81:5200/api/v1/admin/sendEmailAssesRemind", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
...
async function sendEmail(button) {
  ...
  try {
    const response = await fetch(
      "http://18.143.164.81:5200/api/v1/admin/sendEmailAssesRemind",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
